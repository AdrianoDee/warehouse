...
process = cms.Process('RECO',Run3_pp_on_PbPb,genJetSubEvent)
...
reconame = 'file:hionpixel_legacy'
dqmname = 'file:hionpixel_legacy_inDQM'
...
#	process.load("RecoHI.HiTracking.HILowPtConformalPixelTracks_cfi")
#	process.reconstruction = cms.Sequence(process.offlineBeamSpotTask,process.trackerlocalrecoTask,process.hiConformalPixelTracksTaskPhase1)
...
process.tpClusterProducerHIon = validation.tpClusterProducerHIon.clone(pixelClusterSrc = cms.InputTag("siPixelClusters"))
